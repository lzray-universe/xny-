          ...
          , c = {
            ...
            methods: {
                ...
                getAnswers(){
                    ...
                    window.submitAnswerDownload({
                    html: (localStorage.getItem("answers") || "").replace(/&nbsp;/g, ''),
                    name: localStorage.getItem("courseName") || "answer-export"
                })
                },
                getChosenAnswers(){
                    window.submitAnswerDownload({
                    html: (localStorage.getItem("chosenAnswers") || "").replace(/&nbsp;/g, ''),
                    name: localStorage.getItem("courseName") || "answer-export"
                })
                },
                downloadPage(){
          ...
          , c = {
            ...
            methods: {
                ...
                getAnswer(){
                    window.submitAnswerDownload({
                        html: (localStorage.getItem("answers") || "").replace(/&nbsp;/g, ''),
                        name: localStorage.getItem("paperName") || "answer-export"
                    })
                },
